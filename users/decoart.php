...
$password = "2234";
$database="navya";
print "<h1 align='center' style = 'font-family:courier,arial,helvetica;'>Deco Art</h1>";
print "<h3 align='center'>FACT : Art Deco influenced the design of buildings, furniture, jewelry, fashion, cars, movie theatres, trains, ocean liners.</h3> ";
