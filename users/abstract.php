...
$password = "2234";
$database="navya";
print "<h1 align='center' style = 'font-family:courier,arial,helvetica;'>Abstract Art</h1>";
print "<h3 align='center'>FACT : Abstraction indicates a departure from reality in depiction of imagery in art..</h3> ";
