...
$password = "2234";
$database="navya";
print "<h1 align='center' style = 'font-family:courier,arial,helvetica;'>Japanese Art</h1>";
print "<h3 align='center'>FACT : Most of Japanese paintings have an origin in Chinese art</h3> ";
