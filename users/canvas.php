...
$password = "2234";
$database="navya";
print "<h1 align='center' style = 'font-family:courier,arial,helvetica;'>Canvas Art</h1>";
print "<h3 align='center'>FACT : A technique where an artist canvas is stretched over a frame and is secured to the back of the wooden frame .</h3> ";
